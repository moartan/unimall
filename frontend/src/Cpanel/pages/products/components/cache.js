const STORAGE_KEY = 'unimall_product_list_cache_v1';
...
export const buildListKey = (params = {}) => JSON.stringify(params);

export const getListCache = (key) => {
  if (!key) return null;
...
export const setListCache = (key, data) => {
  if (!key) return;
