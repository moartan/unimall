  ...
  return (
    <div className="flex items-center justify-center min-h-[75vh] bg-light-bg dark:bg-dark-bg transition-colors duration-300 px-4">
      ...
      >
        ...
        <h1 className="text-2xl md:text-3xl font-extrabold text-center mb-6 text-primary">Forgot Password</h1>
        ...
        {!submitted ? (
          <form onSubmit={handleSubmit} className="space-y-5">
            {status.error ? (
              <div className="text-sm text-red-600 bg-red-100 rounded p-2 text-center">
                {status.error}
              </div>
            ) : null}
